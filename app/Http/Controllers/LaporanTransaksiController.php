...
class LaporanTransaksiController extends Controller
{
    public function index()
    {
        ...
        $grafikBulanan = Transaksi::selectRaw('MONTH(created_at) as bulan, SUM(total) as total')
        ...
        $transaksiPerTanggal = Transaksi::selectRaw('DATE(created_at) as tanggal, SUM(total) as total_rupiah')
            ->whereIn('status_transaksi_id', [3, 4, 5])
